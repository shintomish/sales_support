...
class SesContractController extends Controller
{
    private function formatDeal(Deal $deal): array
    {
        ...
        return [
            ...
            'category'                     => $sc?->effective_category ?? 'project',
            ...
            'vendor_settlement_unit_minutes' => $sc?->vendor_settlement_unit_minutes,
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $v = $request->validate([
            ...
            'vendor_settlement_unit_minutes' => 'nullable|integer',
        ...
        DB::transaction(function () use ($v, $tenantId, $userId, &$deal) {
            ...
            SesContract::create([
                ...
                'vendor_settlement_unit_minutes' => $v['vendor_settlement_unit_minutes'] ?? null,
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        DB::transaction(function () use ($request, $deal, $tenantId) {
            ...
            $scData = array_filter([
                ...
                'vendor_settlement_unit_minutes' => $request->input('vendor_settlement_unit_minutes'),
