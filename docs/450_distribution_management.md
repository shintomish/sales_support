...
> 作成日: 2026-04-15 / 最終更新: 2026-05-09（停止理由・停止確認ダイアログ・再送信機能・添付ファイル名バックフィルを追記）
...
| 2026-05-08 | 配信停止リンクに **確認ダイアログ** を追加・停止理由 (`unsubscribe_reason`) を 4 種に統一・添付ファイル名 `unknown` をバックフィル・**再送信機能**（行単位 / キャンペーン単位）を実装 |
